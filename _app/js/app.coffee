...
@angular.module('hlApp', ['hlApp.filters', 'hlApp.services', 'hlApp.directives', 'localization']).
    config ['$routeProvider', ($routeProvider) ->
        $routeProvider.
            ...
            when('/topics/:topic_key/chapters/:chapter_key', {templateUrl: 'partials/chapter.html', controller: ChapterDetailController}).
            when('/topics/:topic_key/chapters/:chapter_key/:step', {templateUrl: 'partials/chapter.html', controller: ChapterDetailController}).
